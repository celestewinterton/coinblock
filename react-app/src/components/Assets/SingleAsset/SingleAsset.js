...
const SingleAsset = () => {
  ...
  const cryptoId = Object.values(coins).find(
    (coin) => coin.apiId === apiId
  )?.id;
    ...
    <>
      ...
      <div className="left-section">
        ...
        <div className="card top-margin">
          <div className="row">
            <h2 className="padded">
              {currency(data?.market_data?.current_price?.usd)}
            </h2>
            <div className="padded">
              {data?.market_data?.price_change_percentage_24h > 0 ? (
                <div className="green">
                  +{round(data?.market_data?.price_change_percentage_24h)}%
                </div>
              ) : (
                <div className="red">
                  {round(data?.market_data?.price_change_percentage_24h)}%
          ...
          <div className="row">
            <div className="padded column">
              ...
              <div className="muted1">
                ${bigNum(data?.market_data?.market_cap.usd)}
              </div>
            </div>
            ...
            <div className="padded column">
              ...
              <div className="muted1">
                ${bigNum(data?.market_data?.total_volume.usd)}
              </div>
            </div>
            ...
            <div className="padded column">
              ...
              <div className="muted1">
                {bigNum(data?.market_data?.circulating_supply)}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card top-margin">
          ...
          <div className="padded column">
            ...
            <a
              className="small-text link padded"
      ...
      <div className="right-section">
        <div className="single-asset-watchlist-star">
          {!watching.includes(cryptoId) && (
            <button id={cryptoId} onClick={addToWatch} className="unset">
              Add to Watchlist<i className="fa-regular fa-star"></i>
            </button>
          )}
          {watching.includes(cryptoId) && (
            <button id={cryptoId} onClick={removeFromWatch} className="unset">
