...
const SignUpForm = () => {
  ...
  const onSignUp = async (e) => {
    ...
    if (password !== repeatPassword)
      setErrors({
        password: "Please make sure password and confirmed password match",
      });
    if (password === repeatPassword) {
    ...
    <div className="signup-page-container">
      <div className="row">
            ...
            <form onSubmit={onSignUp}>
              ...
              <div className="row top-margin">
                <div className="column">
                  <div className="form-errors top-margin">
                    {errors.firstName ? (
                      <p>
              ...
              <div className="row top-margin">
                <input
                  ...
                  required={true}
                ></input>
                <div className="pad-left label center">
                  I certify that I am 18 years of age or older, agree to the
                  nonexistant User Agreement, and acknowledge the Privacy
                  Policy.*
                </div>
              </div>
              <button className="wide top-margin round" type="submit">
                Create free account
              </button>
            </form>
            <button
              className="wide top-margin round muted-button"
              onClick={(e) => demoLogin(e)}
            >
              Try a demo
            </button>
            <div className="top-margin muted1">
        ...
        <div className="column signup-right center">
          ...
          <div className="muted1 top-margin">
            Set up your account and verify to get started on trading fake
            crypto. No Terms Apply
          </div>
